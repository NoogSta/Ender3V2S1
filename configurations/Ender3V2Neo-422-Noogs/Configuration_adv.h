...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_5X_STEPS_PER_SEC    30  // (steps/s) Encoder rate for 10x speed   // Ender Configs
  #define ENCODER_10X_STEPS_PER_SEC   80  // (steps/s) Encoder rate for 100x speed  // Ender Configs
